        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-center py-3 mb-4">
                ...
                <ul class="nav nav-tabs my-auto ms-4 mb-3" >
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link bg-tab active" href="advisor_student.php" aria-selected="true">
                            Students
                        </a>
                    </li>
                </ul>  
        ...
        <div class="container py-4">
            <div class="row align-items-md-stretch">
                ...
                <div class="col-md-7 p-5 mb-4 bg-light rounded-3">
                    <?php
                        $result = $connection->query("SELECT * FROM advisor WHERE advisor_id=".$_SESSION['staff_advisor']."");

                        while ($row = $result->fetch_assoc()) {
                            echo '<h1 class="display-5 text-center fw-bold pb-2">'.$row["advisor_fname"].' '.$row["advisor_lname"].'</h1>';
                        }
                    ?>
                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td class="fs-4">'.$row["advisor_id"].'</td>';
                                    echo '</tr>';
      

                                    echo '<tr>';
                                    echo '<td class="fw-bold fs-4">Job Title</td>';
